...
<body>
  <main class="frame">
    ...
    <section class="invitation" aria-label="Private invitation access">
      ...
      <section class="access"><div class="topline"><span>Private invitation</span><i class="seal" aria-hidden="true"></i></div><p class="kicker">Welcome, guest</p><h1>Your invitation is ready to open.</h1><p class="intro">Enter the private access code provided by your host to reveal the celebration details.</p>
